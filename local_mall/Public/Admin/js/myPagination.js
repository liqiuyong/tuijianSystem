...
myPagination.prototype = {
    ...
    firstPage: function firstPage() {
        var that = this;
        var li = document.createElement('li');
        li.innerHTML = '<img src=/Public/Admin/images/img/shouye.png>';
    ...
    lastPage: function lastPage() {
        var that = this;
        var li = document.createElement('li');
        li.innerHTML = '<img src=/Public/Admin/images/img/shangyiye.png>';
    ...
    nextPage: function nextPage() {
        var that = this;
        var li = document.createElement('li');
        li.innerHTML = '<img src=/Public/Admin/images/img/xiayiye.png>';
    ...
    finalPage: function finalPage() {
        var that = this;
        var li = document.createElement('li');
        li.innerHTML = '<img src=/Public/Admin/images/img/weiye.png>';
        this.ul.appendChild(li);
        li.onclick = function () {
